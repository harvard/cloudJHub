...
# Launch a cluster with user data mounted on a seperate EBS (with size 4G) than the root EBS  (use  --user_home_ebs_size)
launch_cluster/launch.py --worker_instance_type t2.small --custom_worker_ami ami-f3fa8de5 --manager_instance_type t2.medium --ignore_permissions true --user_home_ebs_size 4 seas_jupyterhub_May1717 ami-41e0b93b subnet-fd9bb4b4 subnet-54502979
238
